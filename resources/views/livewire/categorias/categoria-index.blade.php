<div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-zinc-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold dark:text-white">Categorias</h2> <button wire:click="openModal"
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-200 dark:border-zinc-600">
                                        <div class="flex space-x-2"> <button
                                                ...
                                                wire:click="$dispatch('confirmDelete', { id: {{ $categoria->id }} })"
    ...
    @if($isModalOpen)
        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0">
                <div class="fixed inset-0 bg-gray-500/75 transition" aria-hidden="true" wire:click="closeModal"></div>
                                    ...
                                    <form>
                                        <div class="mb-4">
                                            <label for="nome"
                                                ...
                                                Nome da Categoria
                                            </label> <input type="text" id="nome" wire:model="nome"
    ...
    <div x-data="{ open: false, categoryId: null }" x-init="window.addEventListener('confirm-delete', (event) => {
            open = true; 
            categoryId = event.detail.id;
        })" x-show="open" x-on:confirm-delete.window="open = true; categoryId = $event.detail.id" x-cloak
        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center sm:block sm:p-0">
            ...
            <div x-show="open" x-transition:enter="ease-out duration-300"
                ...
                <div class="bg-gray-50 dark:bg-zinc-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" @click="$wire.delete(categoryId); open = false;"
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('confirmDelete', (data) => {
                window.dispatchEvent(new CustomEvent('confirm-delete', { detail: data }));
            });
        });
